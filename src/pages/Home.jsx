...
import heroImg01 from "../assets/images/medical-logo01.png";
import heroImg02 from "../assets/images/hero-down01.jpg";
...
const Home = () => {
  return (
        ...
        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
          ...
          <div>
            <div className="lg:w-[570px]">
              <h1 className="text-[36px] leading-[46px] text-headingColor front-[800] md:text-[60px] md:leading-[70px]">
    ...
    <section className="hero__section01">
      <div className="container">
    ...
    <About/>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text_para">3. View our physicians who are accepting new patients, use the
      ...
      <section>
        <div className="container">
          <div className="flex justfy-between gap-[50px] lg:gap-0">
